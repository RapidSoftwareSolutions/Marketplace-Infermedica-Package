...
$app->post('/api/Infermedica/getSingleSymptom', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['appId', 'appKey', 'symptomId']);
    ...
    $url = $settings['apiUrl'] . "/symptoms/" . $postData['args']['symptomId'];
