...
$app->post('/api/Infermedica/getAllConditions', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['appId', 'appId']);
    ...
    $url = $settings['apiUrl'] . "/conditions";
