...
$app->post('/api/Infermedica/getSingleCondition', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['appId', 'appKey', 'conditionId']);
    ...
    $url = $settings['apiUrl'] . "/conditions/" . $postData['args']['conditionId'];
